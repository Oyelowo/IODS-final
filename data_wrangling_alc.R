...
#Description: - This is the script for the data wrangling if students'
#academic performances in two different  subjects: Mathematics
#and Portuguese, as well as attributes about their demographic and
#social features. It also looks at alcohol consumption amongst students.

#original data source:  https://archive.ics.uci.edu/ml/machine-learning-databases/00320/
#install.packages("dplyr")


#rm(list = ls()) #clear files
library(dplyr)
